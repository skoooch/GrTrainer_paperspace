...
class Params:
    ...
    def __init__(self):
        ...
        self.CLS_MODEL_PATH = 'trained-models/%s_epoch%s.pth' % (self.CLS_MODEL_NAME, self.EPOCHS)
        self.GRASP_MODEL_PATH = 'trained-models/%s_epoch%s.pth' % (self.GRASP_MODEL_NAME, self.EPOCHS)
